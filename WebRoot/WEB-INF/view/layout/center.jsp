...
<script type="text/javascript">
	...
	*/
	function layout_center_addTabFun(opts) {
		...
		if (t.tabs('exists', opts.title)) { // 如果已存在，将其选中（使其处于激活状态）即可
			t.tabs('select', opts.title);
		} else {
			t.tabs('add', opts); // 不存在，则添加（打开）一个新的标签页
		}
	}
