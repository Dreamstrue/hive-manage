...
// 						alert("activityId："+r.data.id);
    ...
    function doneIt(){
	    ...
	    parent.layout_center_closeTab("新增抽奖活动");
    }
    </script>
</head>
<body>
    ...
    <div style="margin:20px 0;"></div>
        ...
        <iframe id="previewId" width="100%" height="100%" frameborder=0 scrolling=no src=""></iframe>
        </div>
       ...
       <form id="awardFrom" action="${pageContext.request.contextPath}/activityManage/addOrEditAward.action" method="post">
       		...
       		<input type="hidden" id="awardActivityId" name="awardActivityId" value=""/>
