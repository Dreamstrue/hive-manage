...
<script type="text/javascript">
	$(function() {  
		$('#tagList_manage_datagrid').datagrid({
			url : '${pageContext.request.contextPath}/qrcode/findQrcodeGrid.action?batchId=<%=batchId%>',
			fit : true,
			fitColumns : true,
			border : false,
			rownumbers:true,
			...
			columns : [[
				...
				{ title: 'SN码',field : 'sn',align :'center', width : "25%"},
				...
				{ title: '创建时间', field: 'createTime', align :'center',width: "28%",
				   formatter:function(value,row,index){ 
...
// 				{ title: '绑定sn码', field: 'bindSnCode', align :'center',width: "28%" },
// 				{ title: '绑定时间', field: 'validTime', align :'center',width: "28%",
// 				   formatter:function(value,row,index){ 
// 	                	if(value!=null) {
