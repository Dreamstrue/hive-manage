...
<div align="center" style="width: 100%">
	<form id="category_manage_edit_form" method="post" style="width: 100%">
		...
		<table class="tableForm" style="width: 100%;font-size: 13px;">
			...
			<tr>
				<th>车型名称</th>
				<td><input name="modelid" id="modelid" value="${vo.modelid }" class="easyui-combobox"  data-options="url:'${appPath}/defectCar/getCarBrandModelList.action?brandid=${vo.brandid}&seriesid=${vo.seriesid}',valueField:'id',textField:'modelname',required:true" /></td>
			</tr>
			<tr>
				<th>车型名称</th>
