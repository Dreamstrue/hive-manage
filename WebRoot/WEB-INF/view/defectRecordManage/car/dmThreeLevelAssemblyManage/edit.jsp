...
<div align="center" style="width: 100%">
	<form id="category_manage_edit_form" method="post" style="width: 100%">
		...
		<table class="tableForm" style="width: 100%;font-size: 13px;">
			...
			<tr>
				<th>系列名称</th>
				<td><input name="subAssemblyId"  class="easyui-combobox" value="${vo.subAssemblyId}" data-options="url:'${appPath}/defectCar/getSubAssemblyList.action?assemblyId=${vo.assemblyId}',valueField:'id',textField:'subAssemblyName',required:true "/></td>
			</tr>
			<tr>
				<th>系列名称</th>
				<td><input name="threeLevelAssemblyName" value="${vo.threeLevelAssemblyName }" class="easyui-validatebox" data-options="required:true" /></td>
			</tr>
			<tr>
				<th>排序值</th>
				<td >
