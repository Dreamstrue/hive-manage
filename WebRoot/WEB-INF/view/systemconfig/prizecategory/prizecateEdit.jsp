...
<div align="center" style="width: 100%">
	<form id="pcate_manage_edit_form" method="post" style="width: 100%">
		...
		<table class="tableForm" style="width: 100%">
			...
			<tr>
				<th>父级类别</th>
				<td>
					<input  id="parentId" name="parentId" value="${vo.parentId}" class="easyui-combotree" data-options="url:'${appPath}/prizeCate/allPrizeCate.action',parentField:'parentId',lines:true" style="width:200px;" />
				</td>
			</tr>
			<tr>
				<th>类别说明</th>
