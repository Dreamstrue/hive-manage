...
<script type="text/javascript">
	...
	function check(menuid){
			$('#form').form('submit',{
				url:'${appPath}/industry/insert.action',
				success:function(result){
					...
					setTimeout(function(){
						location.href='${appPath}/industry/allmanage.action?id='+menuid;
					},1000);
					}
				}
			});
...
<div id="div1" >当前位置：行业标准&nbsp;&gt;&nbsp;新增</div>
<div id="div2" align="right"><a id="btn" href="${appPath}/industry/allmanage.action?id=${pid}" class="easyui-linkbutton" data-options="iconCls:'icon-reload',plain:true">返回列表</a> </div>
<div align="left" >
