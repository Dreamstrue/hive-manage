	...
	function check(menuid){
		$('#form').form('submit',{
			...
			success:function(result){
				...
				setTimeout(function(){
					location.href='${appPath}/policy/manage.action?id='+menuid;
				},1000);
				}
			}
		});
...
<div id="div2" align="right"><a id="btn" href="${appPath}/policy/manage.action?id=${pid}" class="easyui-linkbutton" data-options="iconCls:'icon-reload',plain:true">返回列表</a> </div>
<div align="left" >
			...
			<td>
				<div>
					<form  id="form" method="post" enctype="multipart/form-data">
						<input type="hidden" name="nmenuid" id="nmenuid" value="${pid}">
						<table >
							<tr>
								<td class="tt">法规标题：</td>
