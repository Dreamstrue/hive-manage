...
<script type="text/javascript">
		...
		$('#file').uploadify({
				...
				'script':'${appPath}/policy/uploadFiles.action', //上传文件的后台处理程序的相对路径
	...
	function check(menuid){
		$('#form').form('submit',{
			url:'${appPath}/policy/insert.action',
			success:function(result){
				...
				setTimeout(function(){
					location.href='${appPath}/policy/allmanage.action?id='+menuid;
				},1000);
				}
			}
		});
...
<div align="left" style="width:70%;heigth:100%">
<div id="div1" >当前位置：政策法规&nbsp;&gt;&nbsp;新增</div>
<div id="div2" align="right"><a id="btn" href="${appPath}/policy/allmanage.action?id=${pid}" class="easyui-linkbutton" data-options="iconCls:'icon-reload',plain:true">返回列表</a> </div>
<div align="left">
					...
					<form  id="form" method="post" enctype="multipart/form-data">
						<table >
							<tr>
								<td class="tt">栏目选择：</td>
								<td>
									<input id="nmenuid" name="nmenuid" class="easyui-combobox" data-options="url:'${appPath}/navMenu/subNavMenu.action?id=${pid}',valueField:'id',textField:'text',required:true " style="width:170px;" />
								</td>
							</tr>
							<tr>
								<td class="tt">法规标题：</td>
								<td><input name="clawname"  id="clawname" class="easyui-validatebox" data-options="required:true"  style="width: 630px;"/></td>
							</tr>
							<tr>
								<td class="tt">概要内容：</td>
								<td>
									<textarea name="clawsummary" id="clawsummary"  rows="8" cols="60" style="width:630px;height:240px;visibility:hidden;"></textarea>
									<script type="text/javascript">
						...
						<p align="right" style="padding-right: 70px;">
								<input type="button" value="提交" onclick="check(${pid})"/>
								<input type="reset" value="重置" onclick="reload()" />
				   			</p>
					</form>
				</div>
			</td>
