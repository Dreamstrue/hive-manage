...
<script type="text/javascript">
		...
		$('#file').uploadify({
				...
				'script':'${pageContext.request.contextPath}/cultural/uploadFiles.action', //上传文件的后台处理程序的相对路径
	...
	function check(){
			$('#form').form('submit',{
				url:'${pageContext.request.contextPath}/cultural/insert.action',
				success:function(result){
					...
					setTimeout(function(){
						location.href='${pageContext.request.contextPath}/cultural/manage.action?id=${menuId}&pid=${pid}';
					},1000);
					}
				}
			});
...
<div id="div1" >当前位置：诚信文化&nbsp;&gt;&nbsp;新增</div>
<div id="div2" align="right"><a id="btn" href="${pageContext.request.contextPath}/cultural/manage.action?id=${menuId}&pid=${pid}" class="easyui-linkbutton" data-options="iconCls:'icon-reload',plain:true">返回列表</a> </div>
<div align="left">
					...
					<form  id="form" method="post" enctype="multipart/form-data">
						<table >
							<tr>
								<td class="tt">栏目选择：</td>
								<td>
									<input id="nmenuid" name="nmenuid" class="easyui-combobox" data-options="url:'${pageContext.request.contextPath}/navMenu/subNavMenu.action?id=${pid}',valueField:'id',textField:'text',required:true " style="width:170px;" value="${menuId}" />
								</td>
							</tr>
							<tr>
								<td class="tt">标题：</td>
							...
							<tr>
								<td class="tt">所属来源：</td>
								<td><input name=cfrom  id="cfrom"  style="width: 630px;"/></td>
							</tr>
							<tr>
								<td class="tt">概要内容：</td>
								<td>
