					...
					<form  id="form" method="post" enctype="multipart/form-data">
						...
						<table >
							<tr>
								<td class="tt">栏目选择：</td>
								<td>
									<input id="nmenuid" name="nmenuid" class="easyui-combobox" data-options="url:'${appPath}/navMenu/subNavMenu.action?id=${pid}',valueField:'id',textField:'text' " style="width:170px;" value="${vo.nmenuid}" disabled="disabled" />
								</td>
							</tr>
							<tr>
								<td class="tt">标题：</td>
