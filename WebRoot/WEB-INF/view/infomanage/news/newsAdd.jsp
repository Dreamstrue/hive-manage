...
<script type="text/javascript">
	...
	function check(){
		...
		$('#form').form('submit',{
			url:'${appPath}/news/insert.action',
					...
					<form  id="form" method="post" enctype="multipart/form-data">
						...
						<table >
							...
							<tr style="display: none;">
								<td class="tt">信息分类：</td>
								<td>
									<input  id="infoCateId" name="infoCateId" value="888" class="easyui-combotree" data-options="url:'${appPath}/infoCate/allInfoTree.action',parentField:'parentId',lines:true,required:true " style="width:170px;" />
								</td>
							</tr>
							<tr>
								<td class="tt">新闻图标：</td>
