...
<script charset="utf-8" src="${appPath}/resources/js/plugin/kindeditor/kindeditor_notice.js"></script>
...
<script type="text/javascript">
	...
	function check(){
		$('#form').form('submit',{
			url:'${appPath}/notice/insert.action',
					...
					<form  id="form" method="post" enctype="multipart/form-data">
						<table >
							...
							<tr id="topend">
								...
								<td>
									<input type='text' name='topend' id='topend' style='width:230px'  class="easyui-validatebox" readonly="readonly" onfocus="WdatePicker({minDate:'%y-%M-{%d}'})"  />
								</td>
							</tr>
							<tr>
								<td class="tt">公告内容：</td>
							...
							<tr>
								<td class="tt">有效期起：</td>
								<td>
									<input type='text' name='validbegin' id='validbegin' style='width:230px'  class='easyui-validatebox' data-options="required:true" readonly="readonly"  onFocus="WdatePicker({minDate:'%y-%M-{%d}'})"/>
								</td>
							</tr>
							<tr>
								<td class="tt">有效期止：</td>
								<td>
									<input type='text' name='validend' id='validend' style='width:230px'  class='easyui-validatebox' readonly="readonly"  onFocus="WdatePicker({minDate:'#F{$dp.$D(\'validbegin\')}'})"  />
								</td>
							</tr>
							<tr>
								<td class="tt">链接地址：</td>
