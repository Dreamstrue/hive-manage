			...
			<form id="editQuestion4CombinationSelect_form" method="post" style="width: 100%">
				...
				<table id="t2" class="tableForm" style="width: 100%;font-size: 12px;">
					...
					<tr>
						...
						<c:if test="${status.index > 1}">
						<td><input name="optionText2" value="${item.optionText}" id="optionText_1" onblur="clearCheckBox(this.id)" class="easyui-validatebox" data-options="validType:'maxLength[100]'" style="width: 300px;"/>&nbsp;&nbsp;<input type='button' name="deleteBtn" title='删除' value='X'/></td>
						</c:if>
