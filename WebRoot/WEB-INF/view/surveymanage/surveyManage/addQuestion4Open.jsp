			...
			<form id="survey_question_add_form" method="post" style="width: 100%">
				...
				<table class="tableForm" style="width: 100%;font-size: 12px;">
					...
					<tr id="selectMinMax" style="display: none;">
						<th>至少</th>
						<td colspan="3">
							&nbsp;<input name="selectmin" id="selectMin" class="easyui-numberspinner" data-options="min:0,max:1000,editable:true,required:true,missingMessage:'请填写选项分值'" value="1" style="width: 50px;" />&nbsp;<b>字</b>&nbsp;&nbsp;
							<b>最多</b>&nbsp;&nbsp;&nbsp;<input name="selectmax" id="selectMax" class="easyui-numberspinner" data-options="min:1,max:1000,editable:true,required:true,missingMessage:'请填写选项分值'" value="1000" style="width: 50px;" />&nbsp;<b>字</b>
						</td>
						<td></td>
					</tr>
					<tr>
						<th>手动选择</th>
						<td colspan="4">
							是<input type="checkbox"  id="selectOption"  name="isSelect"/>
							<span id="datasource" style="display:none;margin-left: 50px;margin-top: -20px;">
								<input id="questionCateId" name="questionCateId" class="easyui-combotree" data-options="url:'${appPath}/questionData/questionCateList.action',parentField : 'parentId',lines:true,checkbox:true,multiple:true,onlyLeafCheck:true" style="width:200px;" />
							</span>
						</td>
					</tr>
				</table>
				...
				$('#selectOption').click(function(){
					...
					if($(this).attr("checked")=="checked"){
						...
						if(nodes.length==1){ //说明有一个节点被选中了
							var node1 = t.tree('find', nodes[0].id);
