...
<html>
	...
	<body>
		<div align="center" style="width: 99%;"><!-- 如果弹出框出现了横向滚动条，把这个 width 改为99% 即可 -->
			<form id="survey_question_add_form" method="post" style="width: 99%">
				...
				<table class="tableForm" style="width: 100%;font-size: 12px;">
					<tr>
						<th>选项内容</th>
						<td><input name="optionText" id="optionText_1" class="easyui-validatebox" data-options="required:true, validType:'maxLength[100]'" style="width: 300px;"/>&nbsp;&nbsp;<b>分值 </b><input name="score" class="easyui-numberspinner" data-options="min:0,max:1000,editable:true,required:true,missingMessage:'请填写选项分值'" value="0" style="width: 40px;" />&nbsp;&nbsp;<b>可填空 </b><input type="checkbox" id="ck_1" /></td>
					</tr>
					<tr>
						<th>选项内容</th>
						<td><input name="optionText" id="optionText_2" class="easyui-validatebox" data-options="required:true, validType:'maxLength[100]'" style="width: 300px;"/>&nbsp;&nbsp;<b>分值 </b><input name="score" class="easyui-numberspinner" data-options="min:0,max:1000,editable:true,required:true,missingMessage:'请填写选项分值'" value="0" style="width: 40px;" />&nbsp;&nbsp;<b>可填空 </b><input type="checkbox" id="ck_2" /></td>
					</tr>
					<tr>
						<th>选项内容</th>
						<td><input name="optionText" id="optionText_3" class="easyui-validatebox" data-options="validType:'maxLength[100]'" style="width: 300px;"/>&nbsp;&nbsp;<b>分值 </b><input name="score" class="easyui-numberspinner" data-options="min:0,max:1000,editable:true,required:true,missingMessage:'请填写选项分值'" value="0" style="width: 40px;" />&nbsp;&nbsp;<b>可填空 </b><input type="checkbox" id="ck_3" /></td>
					</tr>
					<tr>
						<th>选项内容</th>
						<td><input name="optionText" id="optionText_4" class="easyui-validatebox" data-options="validType:'maxLength[100]'" style="width: 300px;"/>&nbsp;&nbsp;<b>分值 </b><input name="score" class="easyui-numberspinner" data-options="min:0,max:1000,editable:true,required:true,missingMessage:'请填写选项分值'" value="0" style="width: 40px;" />&nbsp;&nbsp;<b>可填空 </b><input type="checkbox" id="ck_4" /></td>
					</tr>
				</table>
