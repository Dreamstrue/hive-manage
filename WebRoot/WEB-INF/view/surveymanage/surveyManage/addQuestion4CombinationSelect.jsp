	...
	<body>
		<div align="center" style="width: 100%;">
			<form id="survey_question_add_form" method="post" style="width: 100%">
				...
				<table id="t2" class="tableForm" style="width: 100%;font-size: 12px;">
					...
					<tr>
						<th>选项内容</th>
						<td><input name="optionText2" id="optionText_1" class="easyui-validatebox" data-options="required:true, validType:'maxLength[100]'" style="width: 300px;"/></td>
						<td><span style="color:red;margin-right: 78px;"></span></td><!-- 在这儿调节文字对齐 -->
					</tr>
					<tr>
						<th>选项内容</th>
						<td><input name="optionText2" id="optionText_2" class="easyui-validatebox" data-options="required:true, validType:'maxLength[100]'" style="width: 300px;"/></td>
						<td><span style="color:red;margin-right: 78px;"></span></td><!-- 在这儿调节文字对齐 -->
					</tr>
				</table>
			</form>
		...
		<script type="text/javascript">
			...
			function addOption2(){ 
	            ...
	            var td = $('<td colspan="5"><input name="optionText2" id="optionText_' + ck_numMax + '" onblur="clearCheckBox(this.id)" class="easyui-validatebox" data-options="validType:\'maxLength[100]\'" style="width: 300px;"/>&nbsp;&nbsp;</td>'); //创建td对象
	            td.append(btndel); //将按钮添加到td中
