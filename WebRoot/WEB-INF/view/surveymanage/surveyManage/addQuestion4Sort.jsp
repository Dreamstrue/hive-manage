	...
	<body>
		<div align="center" style="width: 100%;">
			<form id="survey_question_add_form" method="post" style="width: 99%">
				...
				<table class="tableForm" style="width: 100%;font-size: 12px;">
					<tr>
						<th>选项内容</th>
						<td><input name="optionText" id="optionText_1" class="easyui-validatebox" data-options="required:true, validType:'maxLength[100]'" style="width: 300px;"/></td>
					</tr>
					<tr>
						<th>选项内容</th>
						<td><input name="optionText" id="optionText_2" class="easyui-validatebox" data-options="required:true, validType:'maxLength[100]'" style="width: 300px;"/></td>
					</tr>
					<tr>
						<th>选项内容</th>
						<td><input name="optionText" id="optionText_3" class="easyui-validatebox" data-options="validType:'maxLength[100]'" style="width: 300px;"/></td>
					</tr>
					<tr>
						<th>选项内容</th>
						<td><input name="optionText" id="optionText_4" class="easyui-validatebox" data-options="validType:'maxLength[100]'" style="width: 300px;"/></td>
					</tr>
				</table>
				<table id="t1" class="tableForm" style="width: 99%;font-size: 12px;margin-left:8px;"><!-- 在这儿调节文字对齐 -->
				</table>
			</form>
		</div>
		...
		<script type="text/javascript">
			...
			function addOption(){ 
	            ...
	            var td = $('<td><input name="optionText" id="optionText_' + ck_numMax + '" onblur="clearCheckBox(this.id)" class="easyui-validatebox" data-options="validType:\'maxLength[100]\'" style="width: 300px;"/>&nbsp;&nbsp;</td>'); //创建td对象
