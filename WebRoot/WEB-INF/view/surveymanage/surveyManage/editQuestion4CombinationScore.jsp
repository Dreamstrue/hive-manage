...
<html>
	...
	<body>
		<div align="center" style="width: 100%;">
			<form id="editQuestion4CombinationScore_form" method="post" style="width: 100%">
				...
				<table id="t1" class="tableForm" style="width: 100%;font-size: 12px;">
					<tr>
						...
						<td><span style="color:red;margin-right: 88px;">* 必填</span></td>
					</tr>
					<tr>
						<th>问题说明</th>
					...
					<tr>
						...
						<c:if test="${status.index > 1}">
						<td colspan="4">
							<input name="optionText1" value="${item.optionText}" style="width:300px;" class="easyui-validatebox" data-options="required:true,validType:'maxLength[100]'"/>&nbsp;&nbsp;<input type='button' name="deleteBtn" title='删除' value='X'/>
						</td>
						</c:if>
					</tr>
					</c:forEach>
				...
				<table id="t2" class="tableForm" style="width: 100%;font-size: 12px;">
					...
					<tr>
						<th>选项内容</th>
						<c:if test="${status.index <= 1}">
						<td><input name="optionText2" value="${item.optionText}" id="optionText_1" class="easyui-validatebox" data-options="required:true, validType:'maxLength[100]'" style="width: 300px;"/>&nbsp;&nbsp;<b>分值 </b><input name="score" value="${item.score}" class="easyui-numberspinner" data-options="min:0,max:1000,editable:true,required:true,missingMessage:'请填写选项分值'" value="0" style="width: 40px;" /></td>
						</c:if>
						<c:if test="${status.index > 1}">
						<td><input name="optionText2" value="${item.optionText}" id="optionText_1" onblur="clearCheckBox(this.id)" class="easyui-validatebox" data-options="validType:'maxLength[100]'" style="width: 300px;"/>&nbsp;&nbsp;<b>分值 </b><input name="score" value="${item.score}" class="easyui-numberspinner" data-options="min:0,max:1000,editable:true,required:true,missingMessage:'请填写选项分值'" value="0" style="width: 40px;" />&nbsp;&nbsp;<input type='button' name="deleteBtn" title='删除' value='X'/></td>
						</c:if>
