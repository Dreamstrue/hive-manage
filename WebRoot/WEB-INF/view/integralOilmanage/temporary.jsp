				...
				<div class="Ent_menu"  id="div_sn" >
					...
					<div id="div_tab_1" style="text-align:center;margin-top:15px">
				        <form id="myform" method="post" enctype="multipart/form-data">
							<input id="prizeSN" name="prizeSN" type="hidden" value="${sn}"/>
					        <div id="duijiang" style="text-align:center;margin-top:5px">
								<input type="hidden" name="dj_password" id="dj_password" value="${pswd }">
					               <a href="javascript:void(0);" name="btn_submit" id="btn_submit" class="easyui-linkbutton" style="width:60px;height:25px" onclick="addRecord()"><span style="font-size:16px">兑奖</span></a>
							</div>
						</form>
		            </div>
