...
/**
 * 
* Filename: EnterpriseRoomProduct.java  
* Description: 企业产品展示表
...
* Date								Author			Version
* ------------------------------------------------------------------  
* 2014-5-13 下午3:05:43				yanghui 	1.0
 */

@Entity
@Table(name="E_ENT_ROOM_PRODUCT")
public class EnterpriseRoomProduct {
	...
	@Column(name="PROC_INFO",nullable=false,length=4000)
