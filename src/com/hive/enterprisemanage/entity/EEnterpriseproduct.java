...
@Entity
@Table(name="E_ENTERPRISEPRODUCT")
public class EEnterpriseproduct
  implements Serializable
{
  ...
  public EEnterpriseproduct()
  {
  }

  public EEnterpriseproduct(Long nentproid, Long nenterpriseid, String cproductname, String cimplementstandard, String cprocatcode, String cadministrativelicensecategory, String ccertificateno, String ccertificationunit, Date dgetcertificate, Date dcertificateend, String cyearexamine, Double nsalenum, String chasannex, Long ncreateid, Date dcreatetime, String cauditstatus, String cvalid)
  {
