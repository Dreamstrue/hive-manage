...
/**
 * 
* Filename: EnterpriseRoomShow.java  
* Description: 企业秀表
...
* Date								Author			Version
* ------------------------------------------------------------------  
* 2014-5-9 上午9:38:01				yanghui 	1.0
 */
@Entity
@Table(name="E_ENT_ROOM_SHOW")
public class EnterpriseRoomShow {
	/**
	 * 企业秀表主键
	 */
	private Long id;
	 ...
	 * 企业说明
	 */
	private String enterpriseInfo = StringUtils.EMPTY;
	/**
	 * 创建时间
	 */
	...
	@Column(name="ENTER_INFO",nullable=false,length=4000)
