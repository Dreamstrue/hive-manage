...
@Entity
@Table(name="E_QUALIFICATION")
public class EQualification
  implements Serializable
{
  ...
  private String cauditstatus = "1";

  private String auditOpinion = "";

  private String cvalid = "1";

  public EQualification()
  {
  }

  public EQualification(Long nquaid, Long nenterpriseid, String ccertificatename, String ccertificationunit, String ccertificateno, Date dcertificateend, String chasannex, Long ncreateid, Date dcreatetime, String cauditstatus, String cvalid)
  {
    this.nquaid = nquaid;
  ...
  public EQualification(Long nquaid, Long nenterpriseid, String ccertificatename, String ccertificationunit, String ccertificateno, Date dcertificateend, String chasannex, Long ncreateid, Date dcreatetime, Long nmodifyid, Date dmodifytime, Long nauditid, Date daudittime, String cauditstatus, String auditOpinion, String cvalid)
  {
    this.nquaid = nquaid;
    this.nenterpriseid = nenterpriseid;
    this.ccertificatename = ccertificatename;
