...
@Entity
@Table(name="E_ENTERPRISEINFO")
public class EEnterpriseinfo
  implements Serializable
{
  ...
  @Column(name="CORGANIZATIONCODE", nullable=true, length=50)
  ...
  @Column(name="NCREATEID", nullable=true, precision=22, scale=0)
  ...
  @Temporal(TemporalType.DATE)
  @Column(name="DCREATETIME", nullable=true, length=7)
  @JsonSerialize(using=JsonDateSerializer.class)
