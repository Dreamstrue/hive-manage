...
@Entity
@Table(name = "E_AWARDENTERPRISE")
public class EAwardenterprise implements java.io.Serializable {
	...
	/** default constructor */
	public EAwardenterprise() {
	}

	/** minimal constructor */
	public EAwardenterprise(Long nawaentid, Long nenterpriseid,
			String cawards, Date dawardtime, String chasannex,
	...
	@Column(name = "NAWAENTID", unique = true, nullable = true)
	...
	@Column(name = "CAWARDS", nullable = false, length = 4000)
	...
	@Column(name = "DAWARDTIME", nullable = false, length = 7)
