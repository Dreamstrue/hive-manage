...
* Date								Author			Version
* ------------------------------------------------------------------  
* 2013-10-10 上午9:36:28				yanghui 	1.0
 */
public class MD5EncrpytUtil {
	 ...
	 * @return
	 */
	public static String md5Encrypt(String content,String password){
		byte[] mdByte = encrypt(content, password);
		return new String(org.bouncycastle.util.encoders.Hex.encode(mdByte));
	...
	*/
	...
	public static void main(String[] args){
		...
		String content = "admin"; //待加密、解密内容
		String password = SystemCommon_Constant.DEFAULT_PASSWORD_KEY; //密钥
		//加密
